# 实验：Whitted-Style 迭代式光线追踪（Taichi GPU）
本项目基于 Taichi GPU 并行框架实现经典 Whitted 风格光线追踪，采用迭代循环替代递归完成光线弹射，实现硬阴影、镜面反射全局光照效果；场景包含棋盘格地面、漫反射球体、镜面球体，配套可交互 UI 动态调节光源位置与光线最大弹射次数，区分光线投射与光线追踪渲染管线差异。
## 学号姓名专业
202411081073
吕铭浩
计算机科学与技术
